...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function updateLines(from, to, newText, selFrom, selTo/*SOURCEBOX*/,ignoreSync) {
    	
    	//SOURCEBOX EDIT
    	if (!ignoreSync)
    		SyncManager.bufferAdd(from, to, newText);
    	//////////////////////////////
      if (history) {
        var old = [];
    ...
    function replaceRange(code, from, to /*SOURCEBOX*/,ignoreSync) {
      from = clipPos(from);
    ...
    function replaceRange1(code, from, to, computeSel/*SOURCEBOX*/,ignoreSync) {
      var endch = code.length == 1 ? code[0].length + from.ch : code[code.length-1].length;
      var newSel = computeSel({line: from.line + code.length - 1, ch: endch});
      updateLines(from, to, code, newSel.from, newSel.to/*SOURCEBOX*/,ignoreSync);
    }
