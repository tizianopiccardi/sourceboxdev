	...
	<div id="site-bottom-bar-frame">
		<div id="site-bottom-bar-content">
			...
			<div id="menu" class="ui-corner-all">
				...
				<a href="#" onClick="javascript: UsersManager.openWin(); return false;">Online users</a>
				<a href="#" onClick="javascript: RevisionsBrowser.open(); return false;">Restore revision</a>
				<a href="#" onClick="javascript: EditorManager.share(); return false;">Share link</a>
